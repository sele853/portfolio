        ...
        <div className="w-full h-screen flex items-center justify-center font-[Mulish]">
           <div className="flex flex-col lg:flex-row items-center justify-center h-[90vh] ">
               <div className="w-full px-6 lg:px-8 lg:w-2/3 overflow-y-auto h-screen relative custom-scrollbar">
                    <h1 className="font-bold text-8xl lg:text-9xl opacity-10 absolute top-10 right-18  z-0">PORTFOLIO</h1>
                    <div className="mt-32 leading-relaxed z-10">
                        ...
                        <div className="grid grid-cols-2 gap-8 mb-8 mt-12">
                            <div className="rounded-2xl bg-gray-700 px-6 py-8">
                               <img src="pizza-2.png" className="rounded-2xl w-full h-52 object-cover"/>
                            ...
                            <div className="rounded-2xl bg-gray-700 px-6 py-8">
                               <img src="travel-2.png"  className="rounded-2xl w-full h-52 object-cover"/>
                            ...
                            <div className="rounded-2xl bg-gray-700 px-6 py-8">
                               <img src="react-3.png"  className="rounded-2xl w-full h-52 object-cover"/>
                            ...
                            <div className="rounded-2xl bg-gray-700 px-6 py-8">
                                <img src="worldwise-1.png"  className="rounded-2xl w-full h-52 object-cover"/>
