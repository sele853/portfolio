           ...
           <div className="flex flex-col lg:flex-row h-[90vh] justify-center items-center">
               ...
               <div className="w-full lg:w-2/3 px-6 lg:px-12 relative h-full overflow-y-auto custom-scrollbar">
                   ...
                   <div className="lg:hidden w-full flex justify-center items-center mb-8">
                       <img src="./bg-10.jpg" className="h-64 w-full object-cover" />
                   </div>

                   <h1 className="font-[Mulish] text-6xl sm:text-8xl lg:text-9xl font-bold absolute top-10 left-24 z-0 opacity-10">
                       RESUME
                   </h1>
                   <div className="mt-20 lg:mt-24 font-[Mulish] leading-relaxed">
                       <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mt-8">
                           <div className="mt-10">
                               <h2 className="text-3xl sm:text-4xl"><span className="text-green-500">My</span> Experience</h2>
                               <div className="bg-gray-700 rounded-2xl px-6 py-8 mt-10 pb-9">
                                   <div className="mb-4">
                               ...
                               <div className="bg-gray-700 rounded-2xl px-6 py-8 mt-10 pb-14">
                                   <div className="mb-4">
                           ...
                           <div className="mt-10">
                               <h2 className="text-3xl sm:text-4xl"><span className="text-green-500">My</span> Education</h2>
                               <div className="bg-gray-700 rounded-2xl px-6 py-8 mt-10">
                                   <div className="mb-4">
                           ...
                           <div className="mt-10">
                               <h2 className="font-bold text-lg"><span className="text-green-500">Professional</span> Skills</h2>
                               <div className="rounded-2xl bg-gray-700 px-6 py-8 mt-6">
                                   <div className="mb-6">
